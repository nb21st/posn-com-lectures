...
![time_limit_exceeded0](/Lectures/Assets/time_limit_exceeded0.png)
...
![big_o](/Lectures/Assets/big_o.png)

notes:
Big O Notation - เป็นสูตรที่อธิบายอัตราการเติบโตของจำนวนการดำเนินงานภายในออกอริทึมเมื่อต้องรับค่าข้อมูลในจำนวนต่างๆ
...
---
### O(n) เพราะอัตราการเติบโตเป็นเส้นตรงเหมือนกัน
```cpp
...
notes:
Big O Notation ไม่สนว่าค่าจริงมันคือ 10n, n+5, n+300,000 เพราะสุดท้ายแล้ว อัตราการเติมโตของโค๊ดพวกนี้ ก็เป็นแบบสมการเส้นตรง

---
### O(n^2) เพราะอัตราการเติบโตเป็นกำลังสองเหมือนกัน
```cpp
for (int i = 0; i < n*2; i++) {
  for (int j = 0; j < n*3; j++) {
    // โค๊ด O(1)
...
notes:
เช่นเดียวกับตัวแรก ที่ค่าจริงๆของมันคือ 2n * 3n = 6n^2 ซึ่งสิ่งเดียวที่เราสนใจคืออัตราการเติมโต จึงมองเป็น O(n^2)
...
![solution_complexity_estimation](/Lectures/Assets/solution_complexity_estimation.png)
...
---
### เปรียบเทียบเวลาจริง
![efficiency_comparison](/Lectures/Assets/efficiency_comparison.png)
